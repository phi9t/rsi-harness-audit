...
**Rubrics:** v1 letters in this file are historical. Live letters after the 17 August 2026 round are in [`GRADE_BOARD.md`](GRADE_BOARD.md). Scoring rules are in [`RUBRICS.md`](RUBRICS.md). Paper evidence (preprint + official code) is in [`papers/`](papers/). The captured source writeup now lives in [`REPORT.md`](REPORT.md).
